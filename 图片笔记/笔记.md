...
- 为了避免提交代码麻烦 先暂时把scripts中该命令test eslint部分去掉 标准的是应该加上的 每次提交前进行下代码测试 没问题才能提上`"test:nowatch": "cross-env CI=true SKIP_PREFLIGHT_CHECK=true react-scripts test",`
