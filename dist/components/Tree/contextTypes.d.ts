...
export interface TreeContextProps {
    ...
    renderTreeNode: (child: React.ReactElement, index: number, pos: number | string | undefined) => React.ReactElement;
...
export declare const TreeContext: Context<TreeContextProps>;
export {};
